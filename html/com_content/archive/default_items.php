				...
				<dd>
					<div class="parent-category-name">
						...
						<?php if ($params->get('link_parent_category') and !empty($item->parent_slug)) : ?>
							<i class="icon-folder-open"></i> <?php echo JText::sprintf('COM_CONTENT_PARENT', $url); ?>
						<?php else : ?>
							<i class="icon-folder-open"></i> <?php echo JText::sprintf('COM_CONTENT_PARENT', $title); ?>
						<?php endif; ?>
					</div>
				</dd>
			<?php endif; ?>
				...
				<dd>
					<div class="category-name">
						...
						<?php if ($params->get('link_category') and $item->catslug) : ?>
							<i class="icon-folder-open"></i> <?php echo JText::sprintf('COM_CONTENT_CATEGORY', $url); ?>
						<?php else : ?>
							<i class="icon-folder-open"></i> <?php echo JText::sprintf('COM_CONTENT_CATEGORY', $title); ?>
						<?php endif; ?>
					</div>
				</dd>
			<?php endif; ?>
